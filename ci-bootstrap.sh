...
case "${PROJECT_TYPE}" in 
    UEFI)
        BUILD_DEVELOPER_DIR="${XCODE_DIR/VERSION/10.3}"
        ANALYZE_DEVELOPER_DIR="${XCODE_DIR/VERSION/11.6}"
        COVERITY_DEVELOPER_DIR="${XCODE_DIR/VERSION/11.6}"
        ;;
    
    KEXT | TOOL)
        BUILD_DEVELOPER_DIR="${XCODE_DIR/VERSION/11.6}"
        ANALYZE_DEVELOPER_DIR="${XCODE_DIR/VERSION/11.2.1}"
        COVERITY_DEVELOPER_DIR="${XCODE_DIR/VERSION/10.3}"
        ;;
